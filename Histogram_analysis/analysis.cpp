...
int main( int argc, char **argv )
{
  ...
  TF1 *f1 = new TF1("f1","[0]*exp(-0.5*((x-[1])/[2])^2) + [3]*exp(-0.5*((x-[1])/[4])^2)",e1,e12);
  TF1 *f2 = new TF1("f2","[0]*exp(-0.5*((x-[1])/[2])^2) + [3]*exp(-0.5*((x-[1])/[4])^2)",e12, e23);
  TF1 *f3 = new TF1("f3","[0]*exp(-0.5*((x-[1])/[2])^2) + [3]*exp(-0.5*((x-[1])/[4])^2)", e23, e3);
  f1->SetParameter(0,200000);
  f1->SetParameter(1,h1c);
  f1->SetParameter(2,0.02);
  f1->SetParameter(3,10000);
  f1->SetParameter(4,0.04);
  
  f2->SetParameter(0,200000);
  f2->SetParameter(1,h2c);
  f2->SetParameter(2,0.02);
  f2->SetParameter(3,100000);
  f2->SetParameter(4,0.03);
  
  f3->SetParameter(0,200000);
  f3->SetParameter(1,h3c);
  f3->SetParameter(2,0.02);
  f3->SetParameter(3,100000);
  ...
  resultfile << "\nPeak 1 parameters:\n";
  resultfile << "A1 = " << f1->GetParameter(0) << "\n";
  resultfile << "m = " << f1->GetParameter(1) << "\n";
  resultfile << "std1 = " << f1->GetParameter(2) << "\n";
  resultfile << "A2 = " << f1->GetParameter(3) << "\n";
  resultfile << "std2 = " << f1->GetParameter(4) << "\n";

  resultfile << "\nPeak 2 parameters:\n";
  resultfile << "A1 = " << f2->GetParameter(0) << "\n";
  resultfile << "m = " << f2->GetParameter(1) << "\n";
  resultfile << "std1 = " << f2->GetParameter(2) << "\n";
  resultfile << "A2 = " << f2->GetParameter(3) << "\n";
  resultfile << "std2 = " << f2->GetParameter(4) << "\n";

  resultfile << "\nPeak 3 parameters:\n";
  resultfile << "A1 = " << f3->GetParameter(0) << "\n";
  resultfile << "m = " << f3->GetParameter(1) << "\n";
  resultfile << "std1 = " << f3->GetParameter(2) << "\n";
  resultfile << "A2 = " << f3->GetParameter(3) << "\n";
  resultfile << "std2 = " << f3->GetParameter(4) << "\n";
